...
const SectionCard: React.FC<{
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 space-y-4">
          ...
          >
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-3xl bg-gradient-to-br from-blue-500/20 to-emerald-400/15 ring-1 ring-white/10 flex items-center justify-center text-2xl">
                  👤
                </div>
                <div>
                  <div className="text-slate-100 font-semibold">المستخدم</div>
                  <div className="text-xs text-slate-500">email@domain.com</div>
                </div>
              </div>
              <button
                type="button"
                className="px-4 py-3 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition text-slate-100 font-semibold"
              >
                تعديل
              </button>
            </div>
          ...
          <SectionCard title="اللغة والعملة" subtitle="تفضيلات العرض والتمثيل النقدي">
            <div className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-[#94A3B8] mb-2">اللغة</label>
                  <select
                    value={locale}
                ...
                <div>
                  <label className="block text-xs text-[#94A3B8] mb-2">العملة</label>
                  <select
                    value={currency}
              ...
              <div className="text-xs text-slate-400">التفضيلات تحفظ محليًا ويمكن ربطها لاحقًا بالحساب.</div>
            </div>
          </SectionCard>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <div className="h-9 w-16 rounded-2xl border border-white/10 bg-white/5 flex items-center px-1">
        ...
        <div className="space-y-4">
          <SectionCard title="الدعم" subtitle="طرق تواصل احترافية">
            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-emerald-400/10 p-4 shadow-sm">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="space-y-1">
                  <div className="text-[11px] text-slate-400">Support Lead</div>
                  <div className="text-sm font-semibold text-slate-100">المهندس عمار المصوعي</div>

                  <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                      <div className="text-[11px] text-slate-400">Product</div>
                      <div className="text-sm font-semibold text-slate-100">NexaLedger</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                      <div className="text-[11px] text-slate-400">Version</div>
                      <div className="text-sm font-semibold text-slate-100">v0.0.0</div>
                    </div>
                  </div>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <button
                    type="button"
                    className="px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition text-slate-100 font-semibold"
                    onClick={() => {
          ...
          <SectionCard title="حول النظام" subtitle="هوية المنصة والتحقق من التحديثات">
            <div className="space-y-3">
              <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                <div className="text-sm font-semibold text-slate-100">NexaLedger</div>
                <div className="text-xs text-slate-400 mt-1">منصة مالية عربية حديثة مصممة للوضوح والاستقرار التشغيلي.</div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 text-sm text-slate-400 flex items-center">
                  {updateMsg ? <span className="text-emerald-300 font-semibold">{updateMsg}</span> : <span>أنت تستخدم أحدث إصدار من NexaLedger</span>}
                </div>
              </div>
            </div>
          </SectionCard>
